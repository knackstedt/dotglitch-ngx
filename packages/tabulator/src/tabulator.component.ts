import { Component, ElementRef, Input, SimpleChanges, ViewChild, ViewEncapsulation, EventEmitter, Output, ViewContainerRef } from '@angular/core';
...
export class TabulatorComponent<T = any> {
    ...
    ngAfterViewInit() {
        ...
        const table = this.table = new Tabulator(this.ngContainer.element.nativeElement, {
            index: this.key,
